...
public TradeController(Government currentGovernment) {
        this.currentGovernment = currentGovernment;
        }
    public String showAllPlayers(){
        String txt="";
        int i =1;
        for (User user :DataBase.getUsers()) {//TODO : must be use from Government instead of User
            txt += (i + ") " + user.getUsername() + ": " + user.getNickname() + ".\n");
        }
        return txt;
    }
